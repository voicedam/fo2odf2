...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:axsl="http://www.w3.org/1999/XSL/TransformAlias" exclude-result-prefixes="xsl" version="1.0">
    ...
    <xsl:template match="tests">
        ...
        <axsl:stylesheet xmlns:doc="http://xsltsl.org/xsl/documentation/1.0" exclude-result-prefixes="doc"
            version="1.0">
            ...
            <doc:chapter xmlns="">
                ...
                <section>
                    ...
                    <para>
                        The tests are performed using the stylesheet
                        <filename>test.xsl</filename>
                        . Normally this stylesheet is supplied with the XSLTSL distribution, so you shouldn't
                        need to do anything.
                    </para>
                    <para>
                        However, if you have added a new stylesheet module to the library then the
                        <filename>test.xsl</filename>
                        stylesheet must be regenerated. This is done using the
                        <filename>gentest.xsl</filename>
                        stylesheet. To do this, process the
                        <filename>test.xml</filename>
                        file with the stylesheet
                        <filename>gentest.xsl</filename>
                        using your favourite XSLT processor.
                    </para>
                </section>
                ...
                <section>
                    ...
                    <para>
                        ...
                        file with the stylesheet
                        <filename>test.xsl</filename>
                        using your favourite XSLT processor. The result is an XML document. You can process
                        this with the
                        <filename>results.xsl</filename>
                        stylesheet to get formatted html output. A modern browser combined with the
                        <filename>results.css</filename>
                        file gives you green lines for the tests that passed and ugly red ones for the ones
                        that didn't. When the tests fail they also print a text message to the console for
                        quick verification of the correctness.
                    </para>
                </section>
                ...
                <section>
                    ...
                    <para>
                        When a test seems to be stuck in a loop or if you want to verify the tests in some
                        other way, start the
                        <filename>test.xsl</filename>
                        stylesheet with the parameter
                        <userinput>debug='true'</userinput>
                        to get more info printed to the console.
                    </para>
                </section>
            </doc:chapter>
            ...
            <!-- [PBO] added -->
            <axsl:template name="debug">
                <axsl:param name="msg" />
                <axsl:if test="$debug='true'"><axsl:message><axsl:value-of select="$msg" /></axsl:message></axsl:if>
            </axsl:template>
